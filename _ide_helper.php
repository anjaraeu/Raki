 ...
 * Generated for Laravel 7.5.2 on 2020-04-11 14:59:29.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Crypt {
         ...
         * @static 
         */ 
        public static function encrypt($plainValue = null, $serialize = true, $additionalData = null)
        {
                        /** @var \LaravelAEAD\Encrypter $instance */
                        return $instance->encrypt($plainValue, $serialize, $additionalData);
        }
         ...
         * @static 
         */ 
        public static function decrypt($payload, $serialized = true)
        {
                        /** @var \LaravelAEAD\Encrypter $instance */
                        return $instance->decrypt($payload, $serialized);
        }
         ...
         * @static 
         */ 
        public static function generateKey($cipherName = 'XCHACHA20-POLY1305-IETF')
        {
                        return \LaravelAEAD\Encrypter::generateKey($cipherName);
        }
        
        /**
         * Returns the current AEAD cipher on the encrypter instance.
         *
         * @return \LaravelAEAD\Ciphers\AEADCipher 
         * @static 
         */ 
         ...
         * @static 
         */ 
        public static function encodeBase64($rawValue = null)
        {
                        /** @var \LaravelAEAD\Encrypter $instance */
                        return $instance->encodeBase64($rawValue);
        }
         ...
         * @static 
         */ 
        public static function decodeBase64($value = null)
        {
                        /** @var \LaravelAEAD\Encrypter $instance */
                        return $instance->decodeBase64($value);
        }
         ...
         * @static 
         */ 
        public static function makeCipher($key, $cipherName = 'XCHACHA20-POLY1305-IETF')
        {
                        return \LaravelAEAD\Encrypter::makeCipher($key, $cipherName);
        }
         ...
         * @static 
         */ 
        public static function supported($key, $cipherName = 'XCHACHA20-POLY1305-IETF')
        {
                        return \LaravelAEAD\Encrypter::supported($key, $cipherName);
        }
        ...
        {
                        return \LaravelAEAD\Encrypter::getCiphers();
        }
         ...
         * @static 
         */ 
        public static function getCipherClass($cipherName)
        {
                        return \LaravelAEAD\Encrypter::getCipherClass($cipherName);
        }
...
namespace  { 
    ...
    class IFile extends \Illuminate\Support\Facades\File {}
